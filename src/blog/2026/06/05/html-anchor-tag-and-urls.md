...
tags: blogs
layout: markdown.hbs
title: ReggieTheRoman | Anchors Away! The HTML anchor tag and URLs
shortTitle: Anchors Away! The HTML anchor tag and URLs
tldr: tl;dr - Its news to me that URLs can be absolute or relative and thats pretty cool.
